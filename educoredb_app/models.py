...
def create_user_profile(sender,instance,created,**kwargs):
    if created:
        ...
        if instance.user_type==3:
            default_course = Courses.objects.first() or Courses.objects.create(course_name="Computer Science")
            default_session = SessionYearModel.objects.first() or SessionYearModel.objects.create(
