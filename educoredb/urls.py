...
from educoredb_app import views, HodViews, StaffViews, StudentViews
from educoredb_app.EditResultVIewClass import EditResultViewClass
from educoredb import settings
